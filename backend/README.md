...
## Project Structure
    ...
    ├── testapiautoteammemb_76543  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_76543`
...
2. Clone this repo and `cd testapiautoteammemb_76543`
